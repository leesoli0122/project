...
<head>
    ...
    <script src="./js/service/dashboards/dashboardEventFileIntDialog.js?v=${version}"></script>
...
<section>
    ...
    <div class="popup_view_cont">
        <div class="view_title">
            <dl>
                <dt id="dashboardFileIntEventSearchName"></dt>
                <dd id="dashboardFileIntEventSearchValue"></dd>
            </dl>
        </div>
        <div class="tbl">
            <table id="dashboardFileIntEventTable" class="click">
                <colgroup>
                     <col width="52px">
                     <col width="17%">
                     <col width="10%">
                ...
                <tbody>
                <tr onclick="javascript: lf_dashboardFileIntTableClk(this);" style="display: none;">
                    <td class="long_w"></td>
                    <td class="long_w"></td>
                    <td class="long_w"></td>
                    <td class="long_w"></td>
            ...
            <div class="tbl_bottom">
                 <div class="tbl_info fl">
                     <span id="dashboardFileIntCurrentPage">1</span> / <span id="dashboardFileIntTotPage">1</span> 
                 </div>
                 <ul id="dashboardFileIntEventPagination" class="pagination fr">
