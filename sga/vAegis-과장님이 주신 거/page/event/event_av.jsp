...
<head>
	...
	<script src="./js/service/event/eventAV.js?v=${version}"></script>
	...
	$(document).ready(function() {
		$('#event_AV_result_table').DataTable({
			"autoWidth": false,
			"paging": true,
...
<jsp:include page="/page/layout/sidebar.jsp" flush="false">
	<jsp:param name="menuId" value="avEvent" />
</jsp:include>
...
<input type="hidden" id="av_paging" value=""/>
	...
	<div class="sub">
		<div class="event_search_box">
			<div class="event_search_top">
				<div class="event_search_warp fl">
					<div class="event_sel">
						<div id="event_AV_search_type_field" class="sel_box">
							<select id="event_AV_search_type" class="wide event">
                        		...
                        		<option value="category">탐지명</option>
					...
					<div class="searchtime on">
						<div class="searchtime_box">
							<div id="event_AV_date" class="datetimepicker_box">
								<div class='input-group date datetimepicker_min_from'>
									<input id="event_AV_starttime" type='text' class="form-control AV_date" placeholder="검색 시작 시간" />
									<span for="event_AV_starttime" class="input-group-addon">
								...
								<div class='input-group date datetimepicker_min_to'>
									<input id="event_AV_endtime" type='text' class="form-control AV_date" placeholder="검색 끝나는 시간" />
									<span for="event_AV_endtime" class="input-group-addon">
										<span class="glyphicon glyphicon-calendar calender_ico"></span>
									</span>
								</div>
							</div>
						...
						<div class="btn_wrap fl">
							<a href="javascript:lf_addEventAVCondition();" class="btn bline"><span>쿼리 추가</span></a>
							<a href="javascript:lf_eventAVClick();" class="btn">검색</a>
						</div>
					</div>
					<div class="src_ip">
						<div class="src_ip_box">
							<div class="sel_box fl">
								<select id="event_AV_search_operation_src_ip" class="wide">
							...
							<div class="ipt_box fl">
								<input id="event_AV_src_ip" type="text" placeholder="0.0.0.0" name="required">
							</div>
						</div>
						<div class="btn_wrap fl">
							<a href="javascript:lf_addEventAVCondition();" class="btn bline"><span>쿼리 추가</span></a>
					...
					<div class="src_port">
						<div class="src_port_box">
							<div class="sel_box fl">
								<select id="event_AV_search_operation_src_port" class="wide">
									<option value="1" selected="selected">equals(=)</option>
									<option value="11">not equals(!=)</option>
							...
							<div class="ipt_box fl">
								<input id="event_AV_src_port" type="text" placeholder="1 ~ 65535" name="required">
							</div>
						</div>
						<div class="btn_wrap fl">
							<a href="javascript:lf_addEventAVCondition();" class="btn bline"><span>쿼리 추가</span></a>
					...
					<div class="dest_ip">
						<div class="dest_ip_box">
							<div class="sel_box fl">
								<select id="event_AV_search_operation_dest_ip" class="wide">
									<option value="1" selected="selected">equals(=)</option>
									<option value="11">not equals(!=)</option>
								</select>
							</div>
							<div class="ipt_box fl">
								<input id="event_AV_dest_ip" type="text" placeholder="0.0.0.0" name="required">
							</div>
						</div>
						<div class="btn_wrap fl">
							<a href="javascript:lf_addEventAVCondition();" class="btn bline"><span>쿼리 추가</span></a>
					...
					<div class="dest_port">
						<div class="dest_port_box">
							<div class="sel_box fl">
								<select id="event_AV_search_operation_dest_port" class="wide">
									<option value="1" selected="selected">equals(=)</option>
									<option value="11">not equals(!=)</option>
									<option value="3">less than(&lt;)</option>
									<option value="4">less than or equals(&lt;=)</option>
							...
							<div class="ipt_box fl">
								<input id="event_AV_dest_port" type="text" placeholder="1 ~ 65535" name="required">
							</div>
						</div>
						<div class="btn_wrap fl">
							<a href="javascript:lf_addEventAVCondition();" class="btn bline"><span>쿼리 추가</span></a>
					...
					<div class="action fl">
						<div class="action_box">
							<div class="sel_box fl">
								<select id="event_AV_search_operation_action" class="wide">
									<option value="1" selected="selected">equals(=)</option>
									<option value="11">not equals(!=)</option>
								</select>
							</div>
							<div class="sel_box fl">
								<select id="event_AV_action" class="wide">
					...
					<div class="category fl">
						<div class="category_box">
							<div class="sel_box fl">
								<select id="event_AV_search_operation_category" class="wide">
									<option value="1" selected="selected">equals(=)</option>
									<option value="11">not equals(!=)</option>
									<option value="2">like</option>
									<option value="12">not like</option>
							...
							<div class="ipt_box fl">
								<input id="event_AV_category" type="text" placeholder="" name="required">
							</div>
						</div>
						<div class="btn_wrap fl">
							<a href="javascript:lf_addEventAVCondition();" class="btn bline"><span>쿼리 추가</span></a>
			...
			<div class="event_search_bottom">
				<div id="event_AV_queryTable" class="fl mscrollbar">
					<ul></ul>
				</div>
			</div>
		</div>
		<div class="event_cont_box">
			<div class="event_cont">
				<div class="tbl">
					<table id="event_AV_result_table" class="click">
						<colgroup>
							<col width="8%">
							<col width="20%">
							<col width="15%">
