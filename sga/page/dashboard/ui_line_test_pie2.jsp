...
<head>
	...
	<style>
		.gauge_total_box{ position:relative;width:80px;height:50px;overflow:hidden; }
		...
		.gauge_total_box #chart_gauge{ width:100px;height:100px;top: -10px;position: absolute;left: -10px; }
