...
<head>
	<title>컨테이너 워크로드 실행제어 상세 - Aegis</title>
	...
	<script src="./js/service/event/eventWebhookInfo.js?v=${version}"></script>
			...
			<div id="tabMgmt" class="tab_container">
				<div class="tabMgmt_1 tab_cont open">
					...
					<!-- <div class="detail" id="detailContents" style="padding-top: 10px;">
						...
						<span class="detail_text_color detail_titles">Request</span>
					</div> -->
				</div>
			</div>
		</div>
