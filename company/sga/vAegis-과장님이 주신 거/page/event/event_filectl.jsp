...
<head>
	...
	<script src="./js/service/event/eventFileCtl.js?v=${version}"></script>
	...
	$(document).ready(function() {
		$('#event_fileCtl_result_table').DataTable({
			"autoWidth": false,
			"paging": true,
...
<jsp:include page="/page/layout/sidebar.jsp" flush="false">
	<jsp:param name="menuId" value="fileCtlEvent" />
</jsp:include>
...
<input type="hidden" id="fileCtl_paging" value=""/>
	...
	<div class="sub">
		<div class="event_search_box">
			<div class="event_search_top">
				<div class="event_search_warp fl">
					<div class="event_sel">
						<div id="event_fileCtl_search_type_field" class="sel_box">
							<select id="event_fileCtl_search_type" class="wide event">
					...
					<div class="searchtime on">
						<div class="searchtime_box">
							<div id="event_fileCtl_date" class="datetimepicker_box">
								<div class='input-group date datetimepicker_min_from'>
									<input id="event_fileCtl_starttime" type='text' class="form-control fileCtl_date" placeholder="검색 시작 시간" />
									<span for="event_fileCtl_starttime" class="input-group-addon">
								...
								<div class='input-group date datetimepicker_min_to'>
									<input id="event_fileCtl_endtime" type='text' class="form-control fileCtl_date" placeholder="검색 끝나는 시간" />
									<span for="event_fileCtl_endtime" class="input-group-addon">
										<span class="glyphicon glyphicon-calendar calender_ico"></span>
									</span>
								</div>
							</div>
						...
						<div class="btn_wrap fl">
							<a href="javascript:lf_addEventfileCtlConditionValue();" class="btn bline"><span>쿼리 추가</span></a>
							<a href="javascript:lf_eventfileCtlClick();" class="btn">검색</a>
						</div>
					</div>
					<div class="path">
						<div class="path_box">
							<div class="sel_box fl">
								<select id="event_fileCtl_search_operation_path" class="wide">
							...
							<div class="ipt_box fl">
								<input id="event_fileCtl_path" type="text" placeholder="" name="required">
							</div>
						</div>
						<div class="btn_wrap fl">
							<a href="javascript:lf_addEventfileCtlConditionValue();" class="btn bline"><span>쿼리 추가</span></a>
					...
					<div class="message">
						<div class="message_box">
							<div class="sel_box fl">
								<select id="event_fileCtl_search_operation_message" class="wide">
									<option value="1" selected="selected">equals(=)</option>
									<option value="11">not equals(!=)</option>
									<option value="2">like</option>
									<option value="12">not like</option>
							...
							<div class="ipt_box fl">
								<input id="event_fileCtl_message" type="text" placeholder="이벤트 내용을 적어 주십시오." name="required">
							</div>
						</div>
						<div class="btn_wrap fl">
							<a href="javascript:lf_addEventfileCtlConditionValue();" class="btn bline"><span>쿼리 추가</span></a>
			...
			<div class="event_search_bottom">
				<div id="event_fileCtl_queryTable" class="fl mscrollbar">
					<ul></ul>
				</div>
			</div>
		</div>
		<div class="event_cont_box">
			<div class="event_cont">
				<div class="tbl">
					<table id="event_fileCtl_result_table" class="click">
						<colgroup>
							<col width="8%">
							<col width="20%">
							<col width="20%">
