...
<head>
	...
	<script src="./js/service/event/eventPamAcl.js?v=${version}"></script>
	...
	$(document).ready(function() {
		$('#event_pamAcl_result_table').DataTable({
			"autoWidth": false,
			"paging": true,
...
<jsp:include page="/page/layout/sidebar.jsp" flush="false">
	<jsp:param name="menuId" value="pamAclEvent" />
</jsp:include>
...
<input type="hidden" id="pamAcl_paging" value=""/>
	...
	<div class="sub">
		<div class="event_search_box">
			<div class="event_search_top">
				<div class="event_search_warp fl">
					<div class="event_sel">
						<div id="event_pamAcl_search_type_field" class="sel_box">
							<select id="event_pamAcl_search_type" class="wide event">
								<option value="searchtime">탐지시간</option>
								<option value="permit">허용</option>
					...
					<div class="searchtime on">
						<div class="searchtime_box">
							<div id="event_pamAcl_date" class="datetimepicker_box">
								<div class='input-group date datetimepicker_min_from'>
									<input id="event_pamAcl_starttime" type='text' class="form-control pamAcl_date" placeholder="검색 시작 시간" />
									<span for="event_pamAcl_starttime" class="input-group-addon">
								...
								<div class='input-group date datetimepicker_min_to'>
									<input id="event_pamAcl_endtime" type='text' class="form-control pamAcl_date" placeholder="검색 끝나는 시간" />
									<span for="event_pamAcl_endtime" class="input-group-addon">
										<span class="glyphicon glyphicon-calendar calender_ico"></span>
									</span>
								</div>
							</div>
						...
						<div class="btn_wrap fl">
							<a href="javascript:lf_addEventpamAclConditionValue();" class="btn bline"><span>쿼리 추가</span></a>
							<a href="javascript:lf_eventpamAclClick();" class="btn">검색</a>
						</div>
					</div>
					<div class="permit">
						<div class="permit_box">
							<div class="sel_box fl">
								<select id="event_pamAcl_search_operation_permit" class="wide">
									<option value="1" selected="selected">equals(=)</option>
								</select>
							</div>
							<div class="sel_box fl">
								<select id="event_pamAcl_permit" class="widesub">
					...
					<div class="user">
						<div class="user_box">
							<div class="sel_box fl">
								<select id="event_pamAcl_search_operation_user" class="wide">
									<option value="1" selected="selected">equals(=)</option>
							...
							<div class="ipt_box fl">
								<input id="event_pamAcl_user" type="text" placeholder="" name="required">
							</div>
						</div>
						<div class="btn_wrap fl">
							<a href="javascript:lf_addEventpamAclConditionValue();" class="btn bline"><span>쿼리 추가</span></a>
					...
					<div class="service">
						<div class="service_box">
							<div class="sel_box fl">
								<select id="event_pamAcl_search_operation_service" class="wide">
									<option value="1" selected="selected">equals(=)</option>
									<option value="11">not equals(!=)</option>
									<option value="2">like</option>
									<option value="12">not like</option>
							...
							<div class="ipt_box fl">
								<input id="event_pamAcl_service" type="text" placeholder="" name="required">
							</div>
						</div>
						<div class="btn_wrap fl">
							<a href="javascript:lf_addEventpamAclConditionValue();" class="btn bline"><span>쿼리 추가</span></a>
					...
					<div class="ip">
						<div class="ip_box">
							<div class="sel_box fl">
								<select id="event_pamAcl_search_operation_ip" class="wide">
									<option value="1" selected="selected">equals(=)</option>
									<option value="11">not equals(!=)</option>
									<option value="2">like</option>
									<option value="12">not like</option>
							...
							<div class="ipt_box fl">
								<input id="event_pamAcl_ip" type="text" placeholder="" name="required">
							</div>
						</div>
						<div class="btn_wrap fl">
							<a href="javascript:lf_addEventpamAclConditionValue();" class="btn bline"><span>쿼리 추가</span></a>
					...
					<div class="message">
						<div class="message_box">
							<div class="sel_box fl">
								<select id="event_pamAcl_search_operation_message" class="wide">
									<option value="1" selected="selected">equals(=)</option>
									<option value="11">not equals(!=)</option>
									<option value="2">like</option>
									<option value="12">not like</option>
							...
							<div class="ipt_box fl">
								<input id="event_pamAcl_message" type="text" placeholder="" name="required">
							</div>
						</div>
						<div class="btn_wrap fl">
							<a href="javascript:lf_addEventpamAclConditionValue();" class="btn bline"><span>쿼리 추가</span></a>
			...
			<div class="event_search_bottom">
				<div id="event_pamAcl_queryTable" class="fl mscrollbar">
					<ul></ul>
				</div>
			</div>
		</div>
		<div class="event_cont_box">
			<div class="event_cont">
				<div class="tbl">
					<table id="event_pamAcl_result_table" class="click">
						<colgroup>
							<col width="8%">
							<col width="20%">
							<col width="10%">
