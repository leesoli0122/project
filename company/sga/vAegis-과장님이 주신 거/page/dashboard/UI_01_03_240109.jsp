								...
								<div class="dashboard_chart_donut_box bt1">
									<div class="UI_01_03 donut-chart vulnerabilities">
										<div class="chart_box">
											<div class="chart">
												<div class="low">
													<p class="low-chart" tolltip_pop="tolltip_pop01">
													</p>
												</div>
												<div class="hight" tolltip_pop="tolltip_pop02">
													<p class="hight-chart">
													</p>
												</div>
												<div class="medium">
													<p class="medium-chart" tolltip_pop="tolltip_pop03">
													</p>
												</div>
												<div class="critical">
													<p class="critical-chart"  tolltip_pop="tolltip_pop04">
													</p>
												</div>
												<div class="ignore">
													<p class="ignore-chart"  tolltip_pop="tolltip_pop05">
													</p>
												</div>
											</div>
										</div>
										<div class="chart_data">
											<dl>
												<dd class="critical value" onclick="">506<span>CPU Limits가 설정되어 있는지 확인</span></dd>
												<dd class="hight value" onclick="">506<span>컨테이너가 AllowPrivilegeEscalation으로 실행되즌지 확인</span></dd>
												<dd class="medium value" onclick="">898<span>루트 컨테이너 허용 최소화</span></dd>
												<dd class="low 
												value" onclick="">898<span>CVE-2020-14386 NET_RAW 기능이 있는 컨테이너의 허용이 최소화 되도록 보장</span></dd>
												<dd class="ignore 
												value" onclick="">898<span>호스트 충동을 피하기 위해 컨테이너가 높은 UIDI로 실행되는지 확인 </span></dd>
											</dl>
										</div>
										<!--툴팁모음-->
										<div id="tolltip_pop01" class="tolltip">
											<dl>
												...
												<dd>
													...
													<p>
														...
														프로세스가 네임페이스 외부에서 권한을 에스컬레이션하려고 시도하는 경우 프로세스는 실제사용자에 매핑되지 않고 이는 프로세스가 호스트 시스템에 대한 권한이 없으며 이 방법으로 공격할수 없음을 의미합니다.</br>
														일반적인 Linux Deployment판은 UID 1000을 루트가 아닌 시스템 사용자가 아닌 첫 번째 사용자에게 할당하고 1000명의 사용자가 적적한 버퍼를 제공해야 하므로 이 검사는  UID 1,000 미만에서트리거 됩니다.</br>
													</p>
												</dd>
											</dl>
										</div>
									...
									<script>
										$(window).ready(function(){
											draw(40, '.ignore-chart', '#b2b2b2');
											draw(30, '.critical-chart','#C1282E');
											draw(50, '.hight-chart', '#F7941F');
											draw(50, '.medium-chart', '#FCEE21');
