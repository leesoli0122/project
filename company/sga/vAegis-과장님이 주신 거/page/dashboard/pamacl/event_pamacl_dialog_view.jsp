...
<head>
    ...
    <script src="./js/service/dashboards/dashboardEventPamAclDialog.js?v=${version}"></script>
...
<section>
    ...
    <div class="popup_view_cont">
        <div class="view_title">
            <dl>
                <dt id="dashboardPamAclEventSearchName"></dt>
                <dd id="dashboardPamAclEventSearchValue"></dd>
            </dl>
        </div>
        <div class="tbl">
            <table id="dashboardPamAclEventTable" class="click">
                <colgroup>
                     <col width="52px">
                     <col width="17%">
                     <col width="10%">
                ...
                <tbody>
                <tr onclick="javascript: lf_dashboardPamAclTableClk(this);" style="display: none;">
                    <td class="long_w"></td>
                    <td class="long_w"></td>
                    <td class="long_w"></td>
                    <td class="long_w"></td>
            ...
            <div class="tbl_bottom">
                 <div class="tbl_info fl">
                     <span id="dashboardPamAclCurrentPage">1</span> / <span id="dashboardPamAclTotPage">1</span> 
                 </div>
                 <ul id="dashboardPamAclEventPagination" class="pagination fr">
