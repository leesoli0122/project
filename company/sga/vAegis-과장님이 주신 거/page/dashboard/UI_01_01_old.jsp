								...
								<div class="dashboard_chart_donut_box">
									<div id="cloudvm_chart_donut_2982" class="chart_box dashboard_chart_donut need_registry_select">
										<div class="graph-section">
											...
											<div class="graph" id="vulnerabilities_cloudvm_chart_donut_2982" _echarts_instance_="ec_1695183320546" style="-webkit-tap-highlight-color: transparent; user-select: none; position: relative;">
												<!--<div style="position: relative; width: 347px; height: 400px; padding: 0px; margin: 0px; border-width: 0px; cursor: default;">
													<canvas data-zr-dom-id="zr_0" width="347" height="400" style="position: absolute; left: 0px; top: 0px; width: 347px; height: 400px; user-select: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0); padding: 0px; margin: 0px; border-width: 0px;"></canvas>
												</div>
												...
												<div class="donut-chart vulnerabilities">
													...
													<div class="chart_data">
														<dl>
															...
															<dd class="critical value" onclick="">Critical : <span>1</span></dd>
															<dd class="hight value" onclick="">Hight : <span>53</span></dd>
															<dd class="medum value" onclick="">medum : <span>109</span></dd>
															<dd class="low 
															value" onclick="">low : <span>11</span></dd>
														</dl>
													</div>
												</div><!--//donut-chart-->
											</div>
												...
												<div class="donut-chart scan_completion">
													...
													<div class="chart_data">
														<dl>
															...
															<dd class="sc-scanning none" onclick="">Scanning : <span>0</span></dd>
															<dd class="sc-scanning none" onclick="">Waiting Scan : <span>0</span></dd>
														</dl>
													</div>
												...
												<div class="donut-chart image_assurance">
													...
													<div class="chart_data">
														<dl>
															...
															<dd class="assurance none" onclick="">Assurance : <span>0</span></dd>
														</dl>
													</div>
												</div><!--//donut-chart-->
										...
										<div class="tbl">
											<div id="DataTables_Table_351_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
												...
												<div class="table-bottom">
													<div class="dataTables_paginate paging_simple_numbers" id="DataTables_Table_351_paginate">
														<ul class="pagination">
															<li class="paginate_button previous disabled" id="DataTables_Table_351_previous">
																<a href="#" aria-controls="DataTables_Table_351" data-dt-idx="0" tabindex="0">Previous</a>
															</li>
															<li class="paginate_button active">
																<a href="#" aria-controls="DataTables_Table_351" data-dt-idx="1" tabindex="0">1</a>
															</li>
															<li class="paginate_button next disabled" id="DataTables_Table_351_next">
																<a href="#" aria-controls="DataTables_Table_351" data-dt-idx="2" tabindex="0">Next</a>
															</li>
														</ul>
													</div>
												</div>
...
<script>
	$(window).ready(function(){
		...
		draw(20, '.hight-chart', '#F7941F');
		draw(15, '.medum-chart', '#FFD52F');
		...
		draw(62, '.sc-success-chart', '#79D2DE' );
		draw(27, '.sc-medum-chart','#FFD52F');
		draw(27, '.sc-scanning-chart','#1783FF')
