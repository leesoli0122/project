...
<section>
    ...
    <div class="popup_view_cont ui_01_04_01">
		...
		<div class="view_info">
				<!--s:컨텐츠내용-->
				<p class="tit">Policy Name(e.g. Execution non-warranted container images)</p>	
				<ul class="block">
					<li>
						...
						<div class="form">
							<div class="right">
								<div class="search_box">
									<div class="ipt_box">
										<input class="" type="text" placeholder="RuleName, Kind, User, Message 키워드를 입력해 주세요" id="searchKeyword" name="vulSearchKeyword" style="width:450px;">
									</div>
