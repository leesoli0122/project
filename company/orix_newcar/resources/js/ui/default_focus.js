...
//openPopup 포커스 생성
document.addEventListener('DOMContentLoaded', function() {
    function makeAllDivsFocusable(label) {
        const divs = document.querySelectorAll('div');

        divs.forEach(div => {
            if (div.getAttribute('onclick') && div.getAttribute('onclick').includes('openPopup')) {
...
function closePopup(id, storedScrollPosition) {
	const $target = $('#' + id);
	const targetDiv = document.querySelector('[onclick*="openPopup"]');
