...
function datepicker() {
    $(function () {
		...
		// jkcho 23-07-27
		 $('.datetimepicker_start_from').datetimepicker({
            format: 'YYYY-MM-DD/HH:mm:ss',
            focusOnShow: false,
            sideBySide: true,
            allowInputToggle: true,
        ...
        $('.datetimepicker_end_to').datetimepicker({
            format: 'YYYY-MM-DD/HH:mm:ss',
            focusOnShow: false,
            sideBySide: true,
            allowInputToggle: true,
        ...
        // jkcho 23-07-27
        $(".datetimepicker_start_from").on("dp.change", function (e) {
            $('.datetimepicker_end_to').data("DateTimePicker").minDate(e.date);
        });
        $(".datetimepicker_end_to").on("dp.change", function (e) {
            $('.datetimepicker_start_from').data("DateTimePicker").maxDate(e.date);
        });
...
function lnbEvt() {
    ...
    $('.header_box').on('mouseleave', function () {
        ...
        if ($('.lnb > li.has_children > .depth2 > li > a').hasClass('on')) {
          ...
          $('.lnb > li.has_children has_children > a').parent().removeClass('active');
          $('.lnb > li.has_children > .depth2 > li > a.on').parents('li.has_children').addClass('active');
        } else if ($('.lnb > li.has_children li.has_children > .depth3 > li > a').hasClass('on')) { // depth3
          $('.lnb > li.has_children > a').parent().removeClass('active');
          $('.lnb > li.has_children has_children > a').parent().removeClass('active');
          $('.lnb > li.has_children li.has_children > .depth3 > li > a.on').parents('li.has_children').addClass('active');
        } else {
          $('.lnb > li.has_children > a').parent().removeClass('active');
          $('.lnb > li.has_children has_children > a').parent().removeClass('active');
        }
    ...
    if ($('.lnb > li > ul > li > ul').hasClass('depth3')) { // depth3
    ...
    //depth3
    $('.lnb > li.has_children li.has_children > a').attr('href', '#');
    $('.lnb > li.has_children li.has_children > a').on('click', function (e) {
      e.preventDefault();
      $(this).parent().siblings('li.has_children').removeClass('active');
      $(this).parent().addClass('active');
