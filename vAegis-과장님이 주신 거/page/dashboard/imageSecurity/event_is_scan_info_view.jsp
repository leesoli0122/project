...
<head>
	...
	<script src="./js/common/page_common.js?v=${version}"></script>
 	...
 	<script src="./js/service/dashboards/imageSecurity/eventScanInfo.js?v=${version}"></script>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$('#event_scan_detail_result_table').DataTable({	
				"autoWidth" : false,
				"paging" : true,
...
<body class="win_popup event">
	<section style="background-color:#161b22;">
		<h4 id="cspInfoTitle">Scan Detail View</h4>
					...
					<div class="top scan_top">
						<div class="is_info">
							<div class="is_info_box is_scan_count">
								...
								<div style="color:#6e9fed;" class="successed" onclick="cntClick(this.className)">
									<p id="successedCnt">0</p>
									<p>Successed</p>
								</div>
								<div style="color: #e7766d;" class="failed" onclick="cntClick(this.className)">
									<p id="failedCnt">0</p>
									<p>Failed</p>
								</div>
							...
							<div class="is_info_search_box">
								...
								<a id="scanSearchBtn" href="#" class="btn serch" onclick="searchBtnClick()">검색</a>
							</div>
						</div>
					</div>
					<div class="detail">
						<div class="tbl scan_detail_tbl">
							<table id="event_scan_detail_result_table" class="">
								<colgroup>
									<col width="8%">
									<col width="10%">
									<col width="10%">
