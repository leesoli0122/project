		...
		<div class="sub">
			<div class="alertlist_search_box">
				<ul class="alertlist_search_cont flex_wrap">
					...
					<li class="last" style="position:static">
						<div class="alertlist_search_cont_box">
							<div class="alertlist_search_cont_tit">
								<h4 title="">로그 발생 현황</h4>
							</div>
							<div class="alertlist_search_cont_grap" id="chart_container" style="position:static">
								<script>
								  ...
								  series: [
									{
									 ...
									 areaStyle: {
									  ...
									  color: '#7732F1',
									 data: [1.93, 7.28, 3.76, 0, 0, 0, 0, 0, 5.69, 1.27, 3.85, 1.65, 9.18, 5.82, 4.85, 2.03, 1.26, 1.56, 5.28, 1.87, 2.66, 1.37, 2.68, 5.84, 8.12, 6.83, 1.3, 5.37, 6.44, 2.21, 6.05]
									},
									{
									  ...
									  data: [4.58, 9.46, 2.26, 0, 0, 0, 0,0, 6.98, 4.48, 2.31, 3.33, 7.12, 9.26, 3.92, 2.36, 7.61, 7.96, 4.06, 6.85, 4.5, 5.58, 1.48, 2.16, 4.18, 5.46, 3.48, 4.75, 0.43, 9.65, 5.47]
									},
									{
									  name: '컨테이너 이미지 실행 제어',
									  type: 'line',
									  ...
									  emphasis: {
										focus: 'series'
									  	...
									  	data: [5, 9.01, 0.97, 0, 0, 0, 0, 0, 1.87, 3.98, 2.69, 8.66, 1.01, 6.05, 3.28, 1.53, 8.92, 5, 6, 1, 5, 9, 6.23, 3.56, 5.12, 3.85, 7.58, 3.82, 1.62, 1.92, 4.21]
									},
									{
									  name: '컨테이너 이벤트',
									  type: 'line',
		...
		<div class="sub">
			<div class="alertlist_search_box">
				<ul class="alertlist_search_cont flex_wrap">
					...
					<li style="width:calc(100% - 450px)">
						<div class="alertlist_search_cont_box">
							<div class="alertlist_search_cont_tit">
								<h4 title="">로그 발생 현황</h4>
							</div>

							<div class="alertlist_search_cont_grap" id="chart_container2">
								<script>
								var dom = document.getElementById('chart_container2');
								var myChart = echarts.init(dom, 'dark', {
								  renderer: 'canvas',
								  useDirtyRect: false
								});
