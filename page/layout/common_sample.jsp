...
<link rel="stylesheet" href="/assets/css/reset.css?v=${version}">
...
<script src="/assets/js/lib/dataTables.colReorder.js?v=${version}"></script>
<script src="/assets/js/lib/dataTables.rowReorder.js?v=${version}"></script>
...
<script src="/js/common/event_common.js?v=${version}"></script>
<script src="/js/common/json-viewer.js?v=${version}"></script>
<script src="/js/common/expansion_common.js?v=${version}"></script>
